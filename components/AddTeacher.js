...
export default class AddTeacher extends Component {
    ...
    signUp = (fullName, qualification, email, password) => {
        if (!email || !password) {
        ...
        return auth().createUserWithEmailAndPassword(email, password)
            ...
            .then(uid => this.createUserInDb(uid, fullName, qualification, email, password))
            .catch(
                err => Alert.alert(err.code, err.message)
            )
    }

    createUserInDb = (uid, fullName, qualification, email, password) => {
                ...
                <ScrollView style={{ minHeight: '100%', minWidth: "100%" }}
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{ height: 529, width: '100%', position: 'absolute', top: 140, flex: 1, alignItems: "center", }}>
                            ...
                            <TouchableHighlight style={[styles.buttonContainer, styles.loginButton]} onPress={() => this.signUp(this.state.fullName, this.state.qualification, this.state.email, this.state.password)}>
