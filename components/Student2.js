                ...
                >
                    ...
                    <View style={styles.container}>
                        ...
                        <TouchableHighlight style={{ height: 50, width: 352, position: 'absolute', top: 150, borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "white", alignSelf: "center", position: "absolute" }}>
                            <View style={{ height: 50, width: 352, }}>
                                ...
                                <TouchableHighlight style={{ height: 40, width: 100, position: 'absolute', top: 3, left: 125, borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#F07D7D" }} onPress={this.screen2}>
                    ...
                    <TouchableHighlight style={{ height: 80, width: 165, position: 'absolute', top: '40%', left: "50%", borderRadius: 33, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#FFFFFF" }} >
                        ...
                        <View style={{ height: 600, width: '100%', justifyContent: 'center', alignSelf: 'center', position: 'absolute', top: 200, }}>
                            ...
                            <Text style={{ position: "absolute", left: 25, top: 20, fontSize: 16, fontWeight: 'bold', }}> ENROLLED COURSES</Text>

                            <TouchableHighlight style={{ height: 80, width: 312, position: 'absolute', top: 60, alignSelf: 'center', borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#F07D7D" }} >
                                <View style={{ height: 80, width: 312, }}>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '44%', fontWeight: "normal", fontSize: 12, left: '10%', color: "white" }}>Faculty : Alex FWP</Text>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '20%', fontWeight: "bold", left: '10%', color: "white" }}>Numerical Analysis </Text>
                                </View>
                            </TouchableHighlight>
                            <TouchableHighlight style={{ height: 80, width: 312, position: 'absolute', top: 160, alignSelf: 'center', borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#F07D7D" }} >
                                <View style={{ height: 80, width: 312, }}>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '44%', fontWeight: "normal", fontSize: 12, left: '10%', color: "white" }}>Faculty : Alex FWP</Text>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '20%', fontWeight: "bold", left: '10%', color: "white" }}>Information Security</Text>
                                </View>
                            </TouchableHighlight>
                            <TouchableHighlight style={{ height: 80, width: 312, position: 'absolute', top: 260, alignSelf: 'center', borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#F07D7D" }} >
                                <View style={{ height: 80, width: 312, }}>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '44%', fontWeight: "normal", fontSize: 12, left: '10%', color: "white" }}>Faculty : Alex FWP</Text>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '20%', fontWeight: "bold", left: '10%', color: "white" }}>Object Oriented</Text>
                                </View>
                            </TouchableHighlight>
                            <TouchableHighlight style={{ height: 80, width: 312, position: 'absolute', top: 360, alignSelf: 'center', borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#F07D7D" }} >
                                <View style={{ height: 80, width: 312, }}>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '44%', fontWeight: "normal", fontSize: 12, left: '10%', color: "white" }}>Faculty : Alex FWP</Text>
                                    <Text style={{ position: "absolute", alignSelf: "center", top: '20%', fontWeight: "bold", left: '10%', color: "white" }}>Software Analysis</Text>
                                </View>
                            </TouchableHighlight>
