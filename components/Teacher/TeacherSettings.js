                ...
                <View style={styles.container}>
                    ...
                    <TouchableHighlight style={{ height: 51, width: 312, position: 'absolute', top: 50, borderRadius: 23, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#FBF7F7", alignSelf: "center" }} >
                        <View style={{ height: 51, width: 312, alignSelf: 'center' }}>
                            ...
                            <Text style={{ position: "absolute", alignSelf: "center", top: 10, fontWeight: "800", color: "black", fontSize: 14, }}>OSAMA</Text>
                        </View>
                    </TouchableHighlight>
                    ...
                    <TouchableHighlight style={{ height: 200, width: 312, position: 'absolute', top: 300, alignSelf: "center", borderRadius: 23, borderBottomEndRadius: 2, borderWidth: 1.5, borderColor: "#E7D7D7", backgroundColor: "#FBF7F7" }} source={require('../../assets/Group1071.png')} >
                        <View style={{ height: 336, width: 312, position: 'absolute', justifyContent: 'center' }}>
