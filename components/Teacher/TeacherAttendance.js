...
export default class TeacherAttendance extends Component {
    ...
    storeDataInDb = (pickerValue, pickerValue1) => {
        return firestore().collection('ObjectOrientedProgramming').doc(pickerValue).set(
            {
                pickerValue1
            }
            ...
            <ScrollView
                ...
                >
                    ...
                    <View style={{
                        ...
                        <FlatList style={{ height: 300, width: 390, position: 'absolute', top: 70, alignSelf: "center", borderBottomWidth: 0.5, borderBottomColor: "#E7D7D7", backgroundColor: "white" }}
                            ...
                            renderItem={({ item }) => (
                                <View style={{ height: 71, width: 390, borderBottomWidth: 0.5, }}>
                                    ...
                                    <Picker style={{
                                        height: 50, width: 140, position: 'absolute', top: 10, left: 245, borderColor: 'black', borderWidth: 1, alignSelf: 'center', color: 'black'
                                    }}
                                        selectedValue={this.state.pickerValue1}
                                        onValueChange={(pickerValue1) => this.setState({ pickerValue1 })}
                                    >
                        ...
                        <TouchableHighlight style={{ height: 60, width: 120, top: 400, position: "absolute", alignSelf: 'center', backgroundColor: 'cyan', borderRadius: 15, }} onPress={() => this.storeDataInDb(this.state.pickerValue, this.state.pickerValue1)}>
                            <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'white', alignSelf: 'center', top: 18 }}>SUBMIT</Text>
                        </TouchableHighlight>
                    </View>
