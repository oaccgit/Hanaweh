...
export default class TeacherCM2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                >
                    ...
                    <TouchableHighlight style={{ height: 50, width: 300, alignSelf: 'center', position: 'absolute', top: 240, borderRadius: 23, borderColor: "#E7D7D7", backgroundColor: "#FAFAFA" }} >
                        <View style={{ height: 50, width: 300, }}>
                            ...
                            <TouchableHighlight style={{ height: 40, width: 90, position: 'absolute', top: 2, left: 100, borderBottomWidth: 2.5, borderBottomColor: "#FAFAFA", backgroundColor: "FAFAFA" }} onPress={this.s2}>
                                <Text style={{ top: 10, }}>Assignments</Text>
                            </TouchableHighlight>
                            <TouchableHighlight style={{ height: 40, width: 90, position: 'absolute', top: 2, left: 210, borderBottomWidth: 2.5, borderBottomColor: "#E7D7D7", backgroundColor: "#FAFAFA" }} >
                    ...
                    <Text style={{ fontSize: 16, position: "absolute", alignSelf: "center", top: 310, fontWeight: "bold", left: 60, color: "black" }}>NEW QUIZ</Text>
