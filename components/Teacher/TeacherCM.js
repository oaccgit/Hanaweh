...
import TeacherCM1 from "./TeacherCM1";
import TeacherCM2 from "./TeacherCM2";
import DocumentPicker from 'react-native-document-picker';
import database from '@react-native-firebase/database';
import storage from '@react-native-firebase/storage';
export default class TeacherCM extends Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        >
                            ...
                            <TouchableHighlight style={{ height: 50, width: 300, alignSelf: 'center', position: 'absolute', top: 240, borderRadius: 23, borderColor: "#E7D7D7", backgroundColor: "#FAFAFA" }}  >
                                <View style={{ height: 50, width: 300, }}>
                                    ...
                                    <TouchableHighlight style={{ height: 40, width: 90, position: 'absolute', top: 2, left: 210, borderBottomWidth: 2.5, borderBottomColor: "#FAFAFA", backgroundColor: "#FAFAFA" }} onPress={this.change2}>
