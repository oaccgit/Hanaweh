...
export default class CourseManagement1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
//                     <View style={styles.container}>
//                         <Text style={{ fontSize: 18, position: 'absolute', top: '5%' }}> Assignment</Text>
//                     </View>
//                     <View style={{
...
//                         <View style={{ height: 50, width: 300, }}>
//                             <TouchableHighlight style={{ height: 40, width: 90, position: 'absolute', top: '6%', borderBottomWidth: 2.5, borderBottomColor: "#FAFAFA", backgroundColor: "#FAFAFA" }} onPress={this.s1} >
//                                 <Text style={{ top: "20%", left: "7%" }}>Lectures</Text>
//                             </TouchableHighlight>
//                             <TouchableHighlight style={{ height: 40, width: 90, position: 'absolute', top: '6%', left: "33%", borderBottomWidth: 2.5, borderBottomColor: "#E7D7D7", backgroundColor: "FAFAFA" }} onPress={this.s2}>
...
//                     <Text style={{ fontSize: 16, position: "absolute", alignSelf: "center", top: '50%', fontWeight: "bold", left: '16%', color: "black" }}>UPLOADED</Text>
...
//                     <TouchableHighlight style={{ height: 70, width: 283, position: 'absolute', top: '57%', alignSelf: "center", borderBottomWidth: 0.5, borderRadius: 15, borderBottomColor: "#E7D7D7", backgroundColor: "#E1D7D7" }} >
//                         <View style={{ height: 70, width: 283, }}>
//                             <Image style={{ height: 22, width: 52, top: "30%", left: "40%", position: 'absolute' }} source={require('../assets/upload.png')} />


//                             <Text style={{ fontSize: 12, position: "absolute", alignSelf: "center", top: '34%', color: "blue", fontWeight: "normal", left: '2%', color: "black" }}>Assignment Name</Text>
//                             <Text style={{ fontSize: 8, position: "absolute", alignSelf: "center", top: '34%', color: "blue", fontWeight: "normal", left: '70%', color: "black" }}>20 April 2021</Text>
//                         </View>
//                     </TouchableHighlight>



//                     <TouchableHighlight style={{ height: 70, width: 283, position: 'absolute', top: '69%', alignSelf: "center", borderBottomWidth: 0.5, borderRadius: 15, borderBottomColor: "#E7D7D7", backgroundColor: "#E1D7D7" }} >
//                         <View style={{ height: 70, width: 283, }}>
//                             <Image style={{ height: 22, width: 52, top: "30%", left: "40%", position: 'absolute' }} source={require('../assets/nosubmission.png')} />
//                             <Text style={{ fontSize: 12, position: "absolute", alignSelf: "center", top: '34%', fontWeight: "normal", left: '2%', color: "black" }}>Assignment Name</Text>
//                             <Text style={{ fontSize: 8, position: "absolute", alignSelf: "center", top: '34%', color: "blue", fontWeight: "normal", left: '70%', color: "black" }}>20 April 2021</Text>
